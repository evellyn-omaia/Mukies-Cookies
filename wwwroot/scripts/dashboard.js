...
function escolherImagemDashboard(nome, id) { const texto = String(nome || "").toLowerCase(); if (texto.includes("kinder")) return "cookie-kinder-bueno.png"; if (texto.includes("nutella")) return "cookie-nutella.png"; if (texto.includes("red velvet")) return "cookie-red-velvet.png"; if (texto.includes("chocolate")) return "cookie-chocolate.png"; const imagens = ["cookie-classico.png", "cookie-nutella.png", "cookie-red-velvet.png", "cookie-chocolate.png", "cookie-kinder-bueno.png"]; return imagens[(Number(id || 1) - 1) % imagens.length]; }
